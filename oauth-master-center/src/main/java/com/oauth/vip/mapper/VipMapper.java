...
public interface VipMapper {
    ...
    @Insert("INSERT IGNORE INTO mc_account(nickname,account,img,password,salt,level,status,update_time,create_time) "
    		+ "VALUES(#{nickname},#{account},#{img},#{password},#{salt},#{level},#{status},#{updateTime},#{createTime})")
